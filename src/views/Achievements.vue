      ...
      <v-layout wrap align-center justify-center row fill-height class="my-0">
        <v-flex xs12 md10 class="my-0">
            ...
            <ul>
              ...
              <br>
              <li class="google-font mb-0" style="font-size:120%">Published a conference paper title <a href="https://ieeexplore.ieee.org/abstract/document/7843556" style="text-decoration:none">"Development of low cost upper and lower extremities rehabilitation system with interactive feedback for children with movement disorders"</a> in <a href="https://ieeexplore.ieee.org/xpl/conhome/7829191/proceeding" style="text-decoration:none">2016 IEEE EMBS Conference on Biomedical Engineering and Sciences (IECBES)</a> that held from 4 to 8 December 2016 at The Pullman Bangsar, Kuala Lumpur.</li>
              <br>
              <li class="google-font mb-0" style="font-size:120%">Two (2) teams (<a href="https://www.facebook.com/digitalhealthmalaysia/posts/1024214667654596?__cft__[0]=AZWR2o-2zZIr9GP9bqEiL4v-a0e8iuuCEhqsy-gJHh9u3zxOgbrifagXVa17_DFg9fd5ZII43an4f4oQgKl1GPFdTgm9PdWxEjXL8C2BZXdNwc2sMKDq_H41qs62pcwT3eO153dEzzqrFlaa_NzIeMASm3k8ZRIihOykKnXC52i_Et-sYKdtTWtoynG53zhxYeQ&__tn__=%2CO%2CP-R" style="text-decoration:none">Team A</a> & <a href="https://www.facebook.com/digitalhealthmalaysia/posts/1024215304321199?__cft__[0]=AZWQwaOG-LGO7VS-q93gcqM0ZwLI_HFh4Solkp1N1obtowe-xrYM6koLZYwpi0fKzjf-rV2mnLnuf56DpRAJLt_0rQCg3MKFty0tCD7r4hXtsw9OksPs2812HfnGoz_U3dyubpRrHFYGgzmg0Kn7RC9LhUcNZ-Z0fzrgQoppHRjPHGmOagVuIyH5yBN7qI3kk_k&__tn__=%2CO%2CP-R" style="text-decoration:none">Team B</a>) participated in <a href="https://www.monash.edu.my/mdp/tmb/telemedicine" style="text-decoration:none">Malaysia Telemedicine Innovation Challenge 2016</a>, which is part of the <a href="https://www.monash.edu.my/news-and-events/pages/latest/articles/2016/shaping-tomorrows-healthcare-today" style="text-decoration:none">2nd Telemedicine Conference</a> that held from 16th to 18th August 2016 at Swan Convention Centre, Sunway Medical Centre, Bandar Sunway, Selangor, Malaysia. (One of the participating team official website can be access <a href="https://pengyi00.wixsite.com/mysite-2" style="text-decoration:none">here</a>)</li>
              <br>
              ...
              <br>
              <li class="google-font mb-0" style="font-size:120%">Featured in <a href="https://sight.ieee.org/" style="text-decoration:none">IEEE SIGHT Blog</a> for article <a href="https://sight.ieee.org/training-sessions-hac-sight-malaysia/" style="text-decoration:none">"Training Sessions in HAC/SIGHT Malaysia"</a> on 31st May 2018.</li>
              <br>
